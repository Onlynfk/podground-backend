...
class AccessControl:
    ...
    def get_user_role(self, user_id: str) -> Optional[str]:
        ...
        try:
            result = (
                self.supabase_client.service_client.table("user_roles")
                .select("role")
                .eq("user_id", user_id)
                .eq("is_active", True)
    ...
    def can_access_premium_resources(self, user_id: str) -> bool:
        ...
        try:
            ...
            result = (
                self.supabase_client.service_client.table("subscription_plans")
                .select("can_access_premium_resources")
...
def get_access_control() -> AccessControl:
    ...
    if access_control is None:
        raise HTTPException(
            status_code=500, detail="Access control not initialized"
        )
...
async def get_user_subscription_status(user_id: str) -> Dict:
    ...
    try:
        ...
        return {"is_premium": False, "plan_name": "free", "status": "active"}
