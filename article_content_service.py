...
class ArticleContentService:
    def __init__(self):
        ...
        self.r2_public_url = os.getenv('R2_PUBLIC_URL', f"https://content.podground.com")
...
"""
            ...
            logger.info(f"Successfully uploaded article content for resource {resource_id}")
    ...
    async def get_article_content(self, resource_id: str) -> Optional[str]:
        ...
        try:
            ...
            logger.warning(f"Article content not found for resource {resource_id}")
            return None
        except Exception as e:
    ...
    async def get_article_metadata(self, resource_id: str) -> Optional[Dict[str, Any]]:
        """
